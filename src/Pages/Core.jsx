...
function Core() {
  ...
  const handleFormSubmit = (transaction, transactionType, category, amount) => {
    ...
    Axios.post("https://finance-management-backend-teal.vercel.app/createUser", {
      ...
      .then((response) => {
        ...
        Axios.get("https://finance-management-backend-teal.vercel.app/getUsers").then((response) => {
